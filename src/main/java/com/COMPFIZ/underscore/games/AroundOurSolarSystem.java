...
public class AroundOurSolarSystem implements Disc{
        ...
        public AroundOurSolarSystem() throws Exception{
        ...
        public void init() throws Exception{
            ...
            direction = new Vector3d(((Physics)Saturn.physics).v.normalize(new Vector3d()));
        ...
        public void update(float interval) {//Add Event-Registry
            if(winMan.isKeyPressed(GLFW.GLFW_KEY_LEFT_BRACKET)){
                EventHandler.dt-=10;
            }
            if(winMan.isKeyPressed(GLFW.GLFW_KEY_RIGHT_BRACKET)){
                EventHandler.dt+=10;
            }
            ...
            double there = ((Physics)Saturn.physics).v.normalize(new Vector3d()).dot(direction);
        ...
        public void cleanup() {
            ...
            System.out.println("dt: " + EventHandler.dt);
        }
